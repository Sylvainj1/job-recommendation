...
J'utilise l'agorithme Alternating Least Squares avec implicit qui est très utilisé pour des recommendations. Pour chaque test_users, je retourne 3 recommendations. J'aurais pu également utilisé du KNN mais ALS est clairement plus performant pour éviter le biais de popularité, c'est à dire plus le poste à d'interaction, plus il va être recommandé. 
